    ...
    <div class="cm-tabs-content">
	    <form class="cm-form-highlight">
			...
			<?php
				...
				echo '<tr><td class="title">Job&nbsp;&nbsp;&nbsp;:</td><td class="value">'. $profile['role'] .'</td></tr><tr>';
				echo '<td class="title">Company&nbsp;&nbsp;&nbsp;:</td><td class="value">'. $profile['company'].'</td></tr>';
				echo '<tr><td class="title">Address&nbsp;&nbsp;&nbsp;:</td><td class="value">'.$profile['address'].'</td></tr>';
				echo '<tr><td class="title">Postal code&nbsp;&nbsp;&nbsp;:</td><td class="value">'.$profile['postal'].'</td></tr></table>';
			?>
