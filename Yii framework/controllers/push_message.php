...
// Push functions
	...
	function push2Android($push_keys, $msg, $push_type = "Common")
	{
		...
		$apiKey = "AIzaSyCUO3er769-UUpKRkiSQ4vWnyZW1WXCZeA";//AIzaSyAaqXIpSupYPl0V_2712LGrz6oW9sRSQKw
		$headers = array(
		...
		if ($total > 0)
		{
			for ($i = 0; $i < $count; $i++)
			{
				...
				// Close connection
				curl_close($ch);
	//print_r($reponse); echo "android ok";
	...
	{
		$ret = true;
		$passphrase = '1234'; //carepetpush2014';
		...
		$apnsCert = '/home/contact2w/public_html/app/protected/controllers/contact2w_apns-product.pem';
		//$apnsCert = 'contact2w_apns-dev.pem';
		$cerfile = 'entrust_2048_ca.cer';
		...
		//require_once dirname(__FILE__) .'/ApnsPHP/abstract.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/push.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/exception.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/feedback.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/message.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/log/embedded.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/log/interface.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/message/custom.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/message/exception.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/push/exception.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/push/server/exception.php';
		//require_once dirname(__FILE__) .'/ApnsPHP/push/server.php';
	
		// Instanciate a new ApnsPHP_Push object
		$push = new ApnsPHP_Push(
			ApnsPHP_Abstract::ENVIRONMENT_PRODUCTION,
			dirname(__FILE__) .'/contact2w_apns-product.pem'
		);
