...
$addLink = Yii::app()->homeUrl . "?r=country/create";
...
?>
        ...
        <div class="buttons-container buttons-bg">
            <div id="float-tool-bar" class="float-left">
                ...
                <span class="submit-button cm-button-main cm-confirm cm-process-items">
                    <input id="btImport" class="cm-confirm cm-process-items" type="submit" name="bt_import" value="Import" />
                </span>
...
<script type='text/javascript'>
    $(document).ready(function(){
       ...
       jQuery(document).on('click','#create_button',function() {
        ...
        $("#btDeleteSelected").click( function(event) {
            ...
            if( idList )
            {
                if( confirm("Are you sure want to delete?") )
                {
                    ...
                    var url = "<?php echo Yii::app()->homeUrl . '?r=country/deleteselected'?>";
        ...
        $("#btImport").click( function(event) {
            if( confirm("Are you sure want to delete and import online?") )
            {
                var url = "<?php echo Yii::app()->homeUrl . '?r=country/import'?>";
