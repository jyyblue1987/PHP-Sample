            ...
            <div id="content_general">
                <fieldset>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="username" name="Admin[username]" class="input-text" size="32" maxlength="50" value="<?php echo $Admin['username']; ?>" />
                    </div>

                    <div class="form-field">
                        <label for="email" class="cm-required cm-email">Email:</label>
                        <input type="text" id="email" name="Admin[email]" class="input-text" size="32" maxlength="100" value="<?php echo $Admin['email']; ?>" />
                    </div>

                    <div class="form-field">
                        <label for="contactno" class="cm-required">Contact No:</label>
                        <input type="text" id="contactno" name="Admin[contactno]" class="input-text" size="32" maxlength="20" value="<?php echo $Admin['contactno']; ?>" />
                    </div>

                    <div class="form-field">
                        <label for="password1" class="cm-required">Password:</label>
                        <input type="password" id="password1" name="Admin[password1]" class="input-text cm-autocomplete-off" size="32" maxlength="32" value="<?php echo $Admin['password1']; ?>" />
                    </div>

                    <div class="form-field">
                        <label for="password2" class="cm-required">Confirm password:</label>
                        <input type="password" id="password2" name="Admin[password2]" class="input-text cm-autocomplete-off" size="32" maxlength="32" value="<?php echo $Admin['password2']; ?>" />
                    </div>
                    ...
                    <div class="form-field">
                        ...
                        <div class="select-field">
                            <input type="radio" name="Admin[status]" id="user_data_0_a"
                                <?php if( $Admin['status']==='1') echo 'checked="checked"'; ?>
