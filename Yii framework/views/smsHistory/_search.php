        ...
        <table cellpadding="0" cellspacing="0" border="0" class="search-header">
            <tr>
                <td style="display:none">
                    <input type="hidden" name="r" value="smshistory/admin">
                </td>
                <td class="search-field nowrap">
                    <label for="elm_from">From:</label>
                    <div class="break">
                        <input class="input-text" type="text" name="SmsHistory[from_mobile]" id="elm_from" value="<?php echo $model->from_mobile; ?>" />
                    </div>
                </td>
                <td class="search-field nowrap">
                    <label for="elm_to">To:</label>
                    <div class="break">
                        <input class="input-text" type="text" name="SmsHistory[to_mobile]" id="elm_to" value="<?php echo $model->to_mobile; ?>" />
                    </div>
                </td>
